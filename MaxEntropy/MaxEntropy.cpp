...
// MaxEntropy.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMaxEntropyApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMaxEntropyApp

CMaxEntropyApp::CMaxEntropyApp()
{
...
// Единственный объект CMaxEntropyApp

CMaxEntropyApp theApp;


// Инициализация CMaxEntropyApp

BOOL CMaxEntropyApp::InitInstance()
{
